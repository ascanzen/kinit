...
Revision ID: e1c9c40a9718
Revises: 
Create Date: 2024-01-31 18:07:04.488063
...
def upgrade():
    ...
    op.create_table('quant_stock',
    sa.Column('code', sa.String(length=10), nullable=False, comment='代码'),
    ...
    sa.Column('volume', sa.Integer(), nullable=False, comment='成交量'),
    sa.Column('turnover', sa.Float(), nullable=False, comment='成交额'),
    sa.Column('amplitude', sa.Float(), nullable=False, comment='振幅'),
    sa.Column('highest', sa.Float(), nullable=False, comment='最高'),
    sa.Column('lowest', sa.Float(), nullable=False, comment='最低'),
    sa.Column('today_open', sa.Float(), nullable=False, comment='今开'),
    sa.Column('yesterday_close', sa.Float(), nullable=False, comment='昨收'),
    sa.Column('volume_ratio', sa.Float(), nullable=False, comment='量比'),
    sa.Column('turnover_rate', sa.Float(), nullable=False, comment='换手率'),
    sa.Column('pe_ratio', sa.Float(), nullable=False, comment='市盈率-动态'),
    sa.Column('pb_ratio', sa.Float(), nullable=False, comment='市净率'),
    sa.Column('total_market_value', sa.Float(), nullable=False, comment='总市值'),
    sa.Column('circulating_market_value', sa.Float(), nullable=False, comment='流通市值'),
    sa.Column('rise_speed', sa.Float(), nullable=False, comment='涨速'),
    sa.Column('five_minute_change', sa.Float(), nullable=False, comment='5分钟涨跌'),
    sa.Column('sixty_day_change_percent', sa.Float(), nullable=False, comment='60日涨跌幅'),
    sa.Column('year_to_date_change_percent', sa.Float(), nullable=False, comment='年初至今涨跌幅'),
